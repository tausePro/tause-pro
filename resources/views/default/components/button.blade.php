@php
    ...
    $variations = [
        'variant' => [
            ...
            'link' =>
                'lqd-btn-link bg-transparent text-foreground hover:underline p-0 hover:transform-none hover:shadow-none focus-visible:underline p-0 focus-visible:translate-y-0 focus-visible:shadow-none focus-visible:outline-0',
        ],
        'hoverVariant' => [
