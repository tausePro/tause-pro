...
>
    ...
    >
        ...
        <div class="lqd-chat-form-inputs-container flex min-h-[52px] w-full flex-col rounded-[26px] border border-input-border max-md:min-h-[45px]">
            ...
            <div class="relative flex grow items-center overflow-visible">
                <input
                    id="selectImageInput"
                    type="file"
                    style="display: none;"
                ...
                {{-- Brand Voice badge (indicador visual) --}}
                <div
                    id="brand_voice_badge"
                    class="pointer-events-none absolute top-0 left-5 -translate-y-full z-50 hidden items-center gap-2 rounded-full bg-secondary/20 px-3 py-1 text-xs text-secondary-foreground shadow-sm"
                >
                    <span class="inline-block h-2 w-2 rounded-full bg-secondary"></span>
                    <span class="font-medium" id="brand_voice_badge_text"></span>
                </div>
