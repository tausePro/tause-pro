        ...
        <div class="row">
            ...
            >
                <div class="col-md-12">
                    <div
                        class="form-control mb-3 border-none p-0 [&_.select2-selection--multiple]:!rounded-[--tblr-border-radius] [&_.select2-selection--multiple]:!border-[--tblr-border-color] [&_.select2-selection--multiple]:!p-[1em_1.23em]">
                        <label class="form-label">{{ __('Tavily API Key') }}</label>
                        ...
                        <input
                            ...
                            type="text"
                            name="tavily_api_key"
                            value="{{ setting('tavily_api_key') }}"
                        >
                        <x-alert class="mt-2">
                            <p>
                                {{ __('Used for brand research and competitor/review discovery in Chatbot Training.') }}
                                <a target="_blank" href="https://tavily.com/">{{ __('Get an API key') }}</a>
                            </p>
                        </x-alert>
                    </div>
                </div>
