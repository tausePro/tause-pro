...
Route::prefix('chatbot')->name('api.chatbot.')->group(function () {
    Route::get('/{uuid}/config', 'App\Http\Controllers\ExternalChatbotController@config')->name('config');
    Route::post('/{uuid}/chat', 'App\Http\Controllers\ExternalChatbotController@chat')->name('chat');
    Route::get('/{uuid}/triggers', 'App\Http\Controllers\ExternalChatbotController@triggers')->name('triggers');
    Route::post('/{uuid}/enable-sound', 'App\Http\Controllers\ExternalChatbotController@enableSound')->name('enable-sound');
    Route::get('/{uuid}/history', 'App\Http\Controllers\ExternalChatbotController@history')->name('history');
    Route::post('/{uuid}/store-message', 'App\Http\Controllers\ExternalChatbotController@storeMessage')->name('store-message');
});
