...
class ExtensionRepository implements ExtensionRepositoryInterface
{
    ...
    public function request(string $method, string $route, array $body = [], $fullUrl = null)
    {
        ...
        // HACK TEMPORAL: Reportar dominio de dev para usar las mismas licencias
        $currentHost = request()->getHost();
        $reportedDomain = ($currentHost === 'app.tause.pro' || $currentHost === '34.207.248.220') 
            ? 'tausepro.test' 
            : $currentHost;
