...
class UserController extends Controller
{
    ...
    public function userSettingsSave(Request $request)
    {
        ...
        if ($request->hasFile('avatar')) {
            ...
            if (! MarketplaceHelper::isRegistered('content-manager') && ! in_array(Str::lower($image->getClientOriginalExtension()), $imageTypes)) {
                $data = [
    ...
    protected function getUserVideos(): \Illuminate\Support\Collection
    {
        $user = Auth::user();
