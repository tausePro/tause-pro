...
@section('titlebar_actions')
    <x-button
            ...
            href="{{ $app_is_demo ? '' : LaravelLocalization::localizeUrl(route('dashboard.admin.onboarding-pro.survey.create')) }}"
    >
                        ...
                        <td class="whitespace-nowrap text-end">
                            ...
                            @else
                                <x-button
                                    ...
                                    variant="ghost-shadow"
                                    size="none"
                                    href="{{route('dashboard.admin.onboarding-pro.survey.result',['id' =>$entry->id])}}"
                                    title="{{ __('Results') }}"
                                >
                                ...
                                <x-button
                                        ...
                                        variant="ghost-shadow"
                                        size="none"
                                        href="{{route('dashboard.admin.onboarding-pro.survey.edit',['id' =>$entry->id])}}"
                                        title="{{ __('Edit') }}"
                                >
                                    <x-tabler-pencil class="size-4"/>
                                </x-button>
                                <x-button
                                        ...
                                        hover-variant="danger"
                                        size="none"
										href="{{route('dashboard.admin.onboarding-pro.survey.delete',['id' =>$entry->id])}}"
                                        title="{{ __('Delete') }}"
                                >
                                    <x-tabler-x class="size-4"/>
                                </x-button>
