<div class="relative flex h-[--header-height] shrink-0 flex-wrap items-center gap-2.5 border-b px-4 xl:px-6">
    <x-button
        class="size-8 bg-foreground/10 text-foreground lg:hidden lg:group-[&.focus-mode]/body:flex"
    ...
    >
        ...
        >
            ...
            <span class="max-[330px]:hidden lg:max-xl:hidden" x-text="selectedStatus.label">
                {{ __('Messages') }}
            </span>
            <span
...
{{--							<x-tabler-check class="hidden size-4 text-primary group-[&.active]:block" />--}}
							...
							<span class="text-muted" x-text="statusCount['{{ $key }}'] ?? 0"></span>
