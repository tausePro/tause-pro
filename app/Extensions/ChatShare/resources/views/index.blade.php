...
@endphp
@section('content')
    <div style="height: 600px; margin: 10% 20%;">
        <div
            class="conversation-area flex h-[inherit] grow flex-col justify-between overflow-y-auto rounded-b-[inherit] rounded-t-[inherit] border border-gray-300 max-md:max-h-full"
        ...
        >
            ...
            <div class="relative flex grow flex-col">
                <div @class([
                    ...
                    'md:mb-auto md:pb-6 relative z-10 border border-gray-300',
                ])>

                    @foreach ($messages as $message)
                        @if (isset($category) && $category->slug == 'ai_vision' && count($messages) === 1)
                            @continue
                        @endif
                        ...
                        @if ($message->input != null)
                            <div class="lqd-chat-user-bubble mb-2.5 flex max-w-full flex-row-reverse content-end gap-2 last:mb-0 lg:ms-auto">
                                ...
                                <span
                                    ...
                                    style="background-image: url('{{ url(custom_theme_url('/assets/img/auth/default-avatar.png')) }}')"
                                >
                                    <span class="sr-only">
                                        @lang('You'):
                                    </span>
                                ...
                                <div
                                    ...
                                    <button
                                        class="lqd-clipboard-copy pointer-events-auto invisible absolute -start-5 bottom-0 inline-flex size-10 items-center justify-center rounded-full border-none bg-white p-0 text-black opacity-0 !shadow-lg transition-all hover:-translate-y-[2px] hover:scale-110 group-hover:!visible group-hover:!opacity-100"
                        ...
                        <div class="lqd-chat-ai-bubble mb-2.5 flex max-w-full content-start gap-2 last:mb-0">
                            @if ($message->output != null)
                                ...
                                <div class="chat-content-container group relative max-w-[calc(100%-64px)] rounded-[2em] bg-clay text-heading-foreground dark:bg-white/[2%]">
                                    ...
                                    <button
                                        class="lqd-clipboard-copy pointer-events-auto invisible absolute -end-5 bottom-0 inline-flex size-10 items-center justify-center rounded-full bg-background p-0 text-heading-foreground opacity-0 shadow-lg transition-all hover:-translate-y-0.5 hover:scale-110 group-hover:visible group-hover:opacity-100"
                                        data-copy-options='{ "content": ".chat-content", "contentIn": "<.chat-content-container" }'
                                        title="{{ __('Copy to clipboard') }}"
                                    >
                                        <x-tabler-copy class="size-4" />
    ...
    <template id="chat_user_bubble">
        <div class="lqd-chat-user-bubble mb-2 flex flex-row-reverse content-end gap-2 lg:ms-auto">
            <span
                ...
                style="background-image: url({{ 'assets/img/auth/default-avatar.png' }})"
            >
                <span class="sr-only">
                    @lang('You'):
                </span>
            ...
            <div
                ...
                <button
                    class="lqd-clipboard-copy pointer-events-auto invisible absolute -start-5 bottom-0 inline-flex size-10 items-center justify-center rounded-full border-none bg-background text-foreground opacity-0 shadow-lg transition-all hover:-translate-y-0.5 hover:scale-110 group-hover:visible group-hover:opacity-100"
                    data-copy-options='{ "content": ".chat-content", "contentIn": "<.chat-content-container" }'
                    title="{{ __('Copy to clipboard') }}"
                >
                    <x-tabler-copy class="size-4" />
        ...
        >
            ...
            <div
                ...
                <div class="inline-flex max-w-full items-center rounded-full font-medium leading-none">
                    ...
                    <button
                        class="lqd-clipboard-copy pointer-events-auto invisible absolute -end-5 bottom-0 inline-flex size-10 items-center justify-center rounded-full border-none bg-background text-foreground opacity-0 shadow-lg transition-all hover:-translate-y-0.5 hover:scale-110 group-hover:visible group-hover:opacity-100"
                        data-copy-options='{ "content": ".chat-content", "contentIn": "<.chat-content-container" }'
                        title="{{ __('Copy to clipboard') }}"
                    >
                        <x-tabler-copy class="size-4" />
