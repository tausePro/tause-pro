...
>
    <div class="mx-auto mb-3 size-[90px]">
        ...
        >
            ...
            <span
                ...
                x-show="activeChat != null && !activeChat?.avatar"
    ...
    <h3
        class="mb-2.5"
        x-text="activeChat == null ? '---' : (activeChat?.conversation_name ?? '{{ __('Anonymous User') }}')"
        :contenteditable="activeChat != null && contactInfo.editMode"
