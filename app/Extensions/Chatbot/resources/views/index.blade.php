            ...
            document.addEventListener('alpine:init', () => {
                Alpine.data('externalChatbotEditor', () => ({
                    ...
                    defaultFormInputs: {
                        ...
                        human_agent_offline_message: @json(__('Our human team will reach you during the next business hours.')),
                        ...
                        human_agent_schedule: @json($default_human_agent_schedule),
                        instructions: '',
