...
class Chatbot extends Model
{
    ...
    protected $fillable = [
        ...
        'human_agent_offline_message',
        'human_agent_schedule',
        'human_agent_schedule_enabled',
        'human_agent_timezone',
        'ai_handling_enabled',
        'instructions',
    ...
    protected $casts = [
        ...
        'human_agent_schedule'          => 'array',
        'human_agent_schedule_enabled'  => 'boolean',
