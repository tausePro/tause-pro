...
class ChatbotStoreRequest extends FormRequest
{
    public function rules(): array
    {
        ...
        return [
            ...
            'ai_handling_enabled'           => ['sometimes', 'boolean'],
            'human_agent_schedule_enabled'  => ['sometimes', 'boolean'],
            'human_agent_timezone'          => ['sometimes', 'nullable', 'string'],
            'human_agent_schedule'          => ['sometimes', 'nullable', 'array'],
            'human_agent_schedule.*.day'    => ['required_with:human_agent_schedule', 'string'],
            'human_agent_schedule.*.start'  => ['required_with:human_agent_schedule', 'string'],
            'human_agent_schedule.*.end'    => ['required_with:human_agent_schedule', 'string'],
            'human_agent_schedule.*.enabled'=> ['sometimes', 'boolean'],
            'human_agent_offline_message'   => ['sometimes', 'nullable', 'string'],
